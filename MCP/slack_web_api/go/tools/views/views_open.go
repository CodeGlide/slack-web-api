...
func Views_openHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/views.open%s", cfg.BaseURL, queryString)
...
func CreateViews_openTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_views_open",
		mcp.WithDescription("Open a view for a user."),
