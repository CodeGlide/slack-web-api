...
func Admin_inviterequests_approved_listHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/admin.inviteRequests.approved.list%s", cfg.BaseURL, queryString)
...
func CreateAdmin_inviterequests_approved_listTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_admin_inviteRequests_approved_list",
		mcp.WithDescription("List all approved workspace invite requests."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Admin_inviterequests_approved_listHandler(cfg),
	}
}
