...
func Admin_inviterequests_listHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/admin.inviteRequests.list%s", cfg.BaseURL, queryString)
...
func CreateAdmin_inviterequests_listTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_admin_inviteRequests_list",
		mcp.WithDescription("List all pending workspace invite requests."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Admin_inviterequests_listHandler(cfg),
	}
}
