...
func Admin_teams_owners_listHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/admin.teams.owners.list%s", cfg.BaseURL, queryString)
...
func CreateAdmin_teams_owners_listTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_admin_teams_owners_list",
		mcp.WithDescription("List all of the owners on a given workspace."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Admin_teams_owners_listHandler(cfg),
	}
}
