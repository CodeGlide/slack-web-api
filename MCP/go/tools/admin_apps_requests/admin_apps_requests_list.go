...
func Admin_apps_requests_listHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/admin.apps.requests.list%s", cfg.BaseURL, queryString)
...
func CreateAdmin_apps_requests_listTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_admin_apps_requests_list",
		mcp.WithDescription("List app requests for a team/workspace."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Admin_apps_requests_listHandler(cfg),
	}
}
