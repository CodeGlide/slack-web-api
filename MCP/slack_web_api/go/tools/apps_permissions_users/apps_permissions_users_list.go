...
func Apps_permissions_users_listHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apps.permissions.users.list%s", cfg.BaseURL, queryString)
...
func CreateApps_permissions_users_listTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apps_permissions_users_list",
		mcp.WithDescription("Returns list of user grants and corresponding scopes this app has on a team."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Apps_permissions_users_listHandler(cfg),
	}
}
