...
func Files_remote_listHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/files.remote.list%s", cfg.BaseURL, queryString)
...
func CreateFiles_remote_listTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_files_remote_list",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Files_remote_listHandler(cfg),
	}
}
